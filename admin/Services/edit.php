...
<div class="container">
    ...
    <input type="hidden" name="txtId" value="<?php echo $s_row['serv_id']?>"/>
        ...
        <input type="text" name="txtName" class="form-control" value="<?php echo $s_row['serv_name']?>"/>
        <br>
        ...
        <br> -->
        <input type="submit" class="btn btn-primary" value="Update Service" name="btnEdit"/>
    </form>
    </div>
    <?php
